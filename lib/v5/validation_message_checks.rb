  ...
  class ValidationMessageChecks
    def self.check(line)
      ...
      if (line.include?('The Coding provided (urn:oid:2.16.840.1.113883.6.238#1002-5) is not in the value set http://hl7.org/fhir/us/core/ValueSet/omb-race-category')  ||
          ...
          line.include?('The Coding provided (http://terminology.hl7.org/CodeSystem/v3-NullFlavor#ASKU) is not in the value set http://hl7.org/fhir/us/core/ValueSet/omb-race-category')  ||
          line.include?('The Coding provided (http://terminology.hl7.org/CodeSystem/v3-NullFlavor#UNK) is not in the value set http://hl7.org/fhir/us/core/ValueSet/omb-race-category')  ||
          # the tooling can't expand this valueset for some reason...
          ...
          line.include?('The Coding provided (http://terminology.hl7.org/CodeSystem/v3-NullFlavor#ASKU) is not in the value set http://hl7.org/fhir/us/core/ValueSet/omb-ethnicity-category')  ||
          line.include?('The Coding provided (http://terminology.hl7.org/CodeSystem/v3-NullFlavor#UNK) is not in the value set http://hl7.org/fhir/us/core/ValueSet/omb-ethnicity-category')  ||
          # the tooling can't expand this valueset for some reason...
